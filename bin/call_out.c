...
void new_call_out(ob, fun, delay, arg)
	struct object* ob;char* fun;int delay;struct svalue* arg;
{
	...
	{
		int i;
		call_list_free = (struct call*) xalloc(
		CHUNK_SIZE * sizeof(struct call));
